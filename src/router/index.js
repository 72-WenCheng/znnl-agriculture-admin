...
import OriginResult from '@/views/iaAgriculture/origin/originResult'
import OriginIndex from '@/views/iaAgriculture/origin/index'
...
export const constantRoutes = [
  ...
  {
    path: '/dataV',
    component: (resolve) => require(['@/views/dataV/index'], resolve),
    hidden: true,
  },
  {
    path: '/preview',
    component: (resolve) => require(['@/views/agriculture/components/EditPage/Preview/index'], resolve),
    hidden: true,
  },
  {
    path: '/login',
...
//   },
  ...
  },
  {
    ...
    //   {
    //     path: 'device-view',
    //     component: (resolve) => require(['@/views/iot/device/device-view'], resolve),
    //     name: 'DeviceView',
    //     meta: { title: '查看设备设备', activeMenu: '/iot/device-view', noCache: true}
    //   },
    ]
  }
]
